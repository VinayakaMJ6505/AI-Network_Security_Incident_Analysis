      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="overflow-x-auto">
            {topSources.length === 0 ? (
              <div className="py-12 text-center text-slate-500 font-sans">
                <Network className="w-8 h-8 opacity-30 text-cyan-400 mx-auto mb-2" />
                ...
                <tbody className="divide-y divide-slate-800/60">
                  {topSources.map((src, i) => (
                    <tr key={i} className="hover:bg-cyan-500/[0.04] transition-colors">
                      ...
                      <td className="py-3 px-3 text-slate-400 font-sans">{src.country || 'LAN'}</td>
        ...
        <div className="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 sm:p-6 backdrop-blur-xl shadow-xl shadow-black/20">
          ...
          <div className="overflow-x-auto">
            {topPorts.length === 0 ? (
              <div className="py-12 text-center text-slate-500 font-sans">
                <ShieldAlert className="w-8 h-8 opacity-30 text-amber-400 mx-auto mb-2" />
