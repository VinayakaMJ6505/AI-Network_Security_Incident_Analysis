    ...
    <div className="space-y-6">
      ...
      <div className="p-5 sm:p-6 rounded-2xl border border-cyan-500/20 bg-gradient-to-r from-slate-900/90 via-[#0d1424]/90 to-slate-900/90 backdrop-blur-xl shadow-[0_0_30px_rgba(6,182,212,0.06)]">
        ...
        <div className="mt-4 pt-4 border-t border-slate-800/80 flex flex-wrap items-center gap-2">
          <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider mr-1 font-mono">
            Load Template:
          </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Input Panel (Left) */}
        <div className="lg:col-span-6 rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 sm:p-6 backdrop-blur-md flex flex-col">
          ...
          <div className="relative flex-grow">
            <textarea
              ...
              className="w-full h-full min-h-[220px] p-4 text-xs font-mono rounded-xl bg-slate-950/90 border border-slate-800 text-cyan-200 placeholder-slate-500 focus:border-cyan-500 focus:outline-none resize-none leading-relaxed transition-colors selection:bg-cyan-500/30"
            />
          </div>
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3 pt-3 border-t border-slate-800/80">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 text-xs font-bold shadow-[0_0_20px_rgba(6,182,212,0.3)] transition-all disabled:opacity-50 active:scale-95"
            >
        ...
        {/* Output Panel (Right) */}
        <div className="lg:col-span-6 rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 sm:p-6 backdrop-blur-md">
          <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider mb-4 flex items-center gap-2 font-mono">
            <Sparkles className="w-4 h-4 text-cyan-400 animate-pulse" /> Extracted Entities & Detection
          </h3>
          ...
          {!parseResult ? (
            <div className="h-72 flex flex-col items-center justify-center text-center p-6 border border-dashed border-slate-800 rounded-xl text-slate-500">
              ...
              <p className="text-xs font-medium text-slate-400">No log parsed yet.</p>
            ...
            <div className="space-y-4">
              ...
              {parseResult.incident && (
                <div className="p-4 rounded-xl border border-cyan-500/30 bg-gradient-to-br from-[#0c162d] via-slate-900 to-[#111a33] shadow-[0_0_20px_rgba(6,182,212,0.06)]">
